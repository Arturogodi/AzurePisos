...
df_formatted = (datetime_df
    ...
    .withColumn("day_full", date_format(col("ts"), "EEEE"))
    .withColumn("week_of_year", weekofyear(col("ts")))
    .withColumn("month_abbr", date_format(col("ts"), "MMM"))
    .withColumn("month_full", date_format(col("ts"), "MMMM"))
    .withColumn("formatted", date_format(col("ts"), "dd/MM/yyyy HH:mm:ss"))
    .withColumn("iso_format", date_format(col("ts"), "yyyy-MM-dd"))
    .withColumn("time_12hr", date_format(col("ts"), "hh:mm a"))
    .withColumn("time_24hr", date_format(col("ts"), "HH:mm:ss"))
    .withColumn("hour", date_format(col("ts"), "HH"))
    .withColumn("minutes", date_format(col("ts"), "mm"))
    .withColumn("seconds", date_format(col("ts"), "ss"))
)
