...
-- MAGIC
-- MAGIC The Dashboard has been loaded for you. Open the <a dbdemos-dashboard-id="fraud-detection" href='/sql/dashboardsv3/01ef691b0e1c1f45a2303392742727ba' target="_blank">DBSQL FSI Fraud Dashboard</a> to start reviewing our existing Fraud pattern.
