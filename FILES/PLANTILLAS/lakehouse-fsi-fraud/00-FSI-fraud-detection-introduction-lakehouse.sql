...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3987092476296021&notebook=%2F00-FSI-fraud-detection-introduction-lakehouse&demo_name=lakehouse-fsi-fraud&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-fraud%2F00-FSI-fraud-detection-introduction-lakehouse&version=1">
...
-- MAGIC %md 
-- MAGIC Open the FSI banking & Fraud  <a dbdemos-pipeline-id="dlt-fsi-fraud" href="#joblist/pipelines/64c80dfb-916d-483d-ad6f-9bed3dd214e1" target="_blank">Delta Live Table pipeline</a> or the [SQL notebook]($./01-Data-ingestion/01.1-DLT-fraud-detection-SQL) *(Alternatives: DLT Python version Soon available)*. <br>
...
-- MAGIC %md 
-- MAGIC Open the [Datawarehousing notebook]($./03-BI-data-warehousing/03-BI-Datawarehousing-fraud) to start running your BI queries or access or directly open the <a dbdemos-dashboard-id="fraud-detection" href='/sql/dashboardsv3/01ef691b0e1c1f45a2303392742727ba' target="_blank">Banking fraud analysis dashboard</a>
