...
# MAGIC
# MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="dlt-test" href="#joblist/pipelines/42a10fd1-a2ec-4782-a13e-e48ff828a963">Delta Live Table Pipeline for unit-test demo</a>.
# MAGIC
# MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=3987092476296021&notebook=%2FDLT-pipeline-to-test&demo_name=dlt-unit-test&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-unit-test%2FDLT-pipeline-to-test&version=1">
...
# MAGIC         }
# MAGIC     ],
# MAGIC     "name": "dbdemos_dlt_unit_test_{{CATALOG}}_{{SCHEMA}}",
