...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3987092476296021&notebook=%2F00-Credit-Decisioning&demo_name=lakehouse-fsi-credit&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-credit%2F00-Credit-Decisioning&version=1">
...
# MAGIC
# MAGIC Directly open the final <a dbdemos-dashboard-id="credit-decisioning" href='/sql/dashboardsv3/01ef691ae997132d831f19c59e86e16a' target="_blank">dashboard</a> depicting the business outcomes of building the credit decisioning on the Databricks Lakehouse, including:
