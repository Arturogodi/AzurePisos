...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3987092476296021&notebook=%2F02-Data-Governance%2F02-Data-Governance-credit-decisioning&demo_name=lakehouse-fsi-credit&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-credit%2F02-Data-Governance%2F02-Data-Governance-credit-decisioning&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-fsi-credit-jose_a_gomez_diaz` from the dropdown menu ([open cluster configuration](https://adb-3987092476296021.1.azuredatabricks.net/#setting/clusters/0902-110255-krs9um8v/configuration)). <br />
...
GRANT SELECT ON TABLE main.dbdemos_fsi_credit_decisioning.credit_bureau_gold TO `analysts`;
GRANT SELECT ON TABLE main.dbdemos_fsi_credit_decisioning.customer_gold TO `analysts`;
GRANT SELECT ON TABLE main.dbdemos_fsi_credit_decisioning.fund_trans_gold TO `analysts`;

-- We'll grant an extra MODIFY to our Data Engineer
GRANT SELECT, MODIFY ON SCHEMA main.dbdemos_fsi_credit_decisioning TO `dataengineers`;
