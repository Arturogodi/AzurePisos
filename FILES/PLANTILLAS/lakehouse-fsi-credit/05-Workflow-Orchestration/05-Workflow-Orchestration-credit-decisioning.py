...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3987092476296021&notebook=%2F05-Workflow-Orchestration%2F05-Workflow-Orchestration-credit-decisioning&demo_name=lakehouse-fsi-credit&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-credit%2F05-Workflow-Orchestration%2F05-Workflow-Orchestration-credit-decisioning&version=1">
...
# MAGIC * Ingest credit bureau data and banking internal customer data with Delta Live Tables
...
# MAGIC
# MAGIC <a dbdemos-workflow-id="credit-job" href="/#job/3819850910311">Click here to access your Workflow job</a>, it was setup when you installed your demo.
# MAGIC
# MAGIC
