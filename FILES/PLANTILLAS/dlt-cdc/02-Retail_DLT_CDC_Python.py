...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=3987092476296021&notebook=%2F02-Retail_DLT_CDC_Python&demo_name=dlt-cdc&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F02-Retail_DLT_CDC_Python&version=1">
...
# MAGIC
# MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/062fbb6f-8688-40ba-91b7-91f8e31a0f33">Delta Live Table Pipeline for CDC</a>.
...
# MAGIC -- display(spark.read.json("/Volumes/main/dbdemos_dlt_cdc/raw_data/customers"))
...
# MAGIC %md
# MAGIC ## Conclusion 
# MAGIC We now have <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/062fbb6f-8688-40ba-91b7-91f8e31a0f33">our DLT pipeline</a> up & ready! Our `customers` table is materialize and we can start building BI report to analyze and improve our business. It also open the door to Data Science and ML use-cases such as customer churn, segmentation etc.
...
# MAGIC
# MAGIC <a dbdemos-dashboard-id="dlt-expectations" href='/sql/dashboardsv3/01ef691a96091606b3abfb4bb636ca49'  target="_blank">Data Quality Dashboard</a>
