...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=3987092476296021&notebook=%2F03-Retail_DLT_CDC_Monitoring&demo_name=dlt-cdc&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F03-Retail_DLT_CDC_Monitoring&version=1">

# COMMAND ----------

# MAGIC %md 
# MAGIC ### A cluster has been created for this demo
# MAGIC To run this demo, just select the cluster `dbdemos-dlt-cdc-jose_a_gomez_diaz` from the dropdown menu ([open cluster configuration](https://adb-3987092476296021.1.azuredatabricks.net/#setting/clusters/0902-110033-nsvzqsnu/configuration)). <br />
...
# MAGIC %sql
# MAGIC SELECT * FROM event_log(TABLE(main.dbdemos_dlt_cdc.customers)) 
...
# MAGIC   as SELECT * FROM event_log(TABLE(main.dbdemos_dlt_cdc.customers));
...
# MAGIC
# MAGIC We can start creating our first <a dbdemos-dashboard-id="dlt-expectations" href='/sql/dashboardsv3/01ef691a96091606b3abfb4bb636ca49'  target="_blank">DBSQL Dashboard</a> monitoring our data quality & DLT pipeline health.
