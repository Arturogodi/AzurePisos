...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=3987092476296021&notebook=%2F04-Retail_DLT_CDC_Full&demo_name=dlt-cdc&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F04-Retail_DLT_CDC_Full&version=1">

# COMMAND ----------

# DBTITLE 1,2 tables in our cdc_raw: customers and transactions
# uncomment to see the raw files
# %fs ls /Volumes/main/dbdemos_dlt_cdc/raw_data
  ...
  def raw_cdc():
    return (
      spark.readStream.format("cloudFiles")
        ...
        .load("/Volumes/main/dbdemos_dlt_cdc/raw_data/"+table_name))
...
for folder in dbutils.fs.ls("/Volumes/main/dbdemos_dlt_cdc/raw_data"):
