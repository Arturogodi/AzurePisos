...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=DBSQL&org_id=3987092476296021&notebook=%2F00-Identity_PK_FK&demo_name=identity-pk-fk&event=VIEW&path=%2F_dbdemos%2FDBSQL%2Fidentity-pk-fk%2F00-Identity_PK_FK&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-identity-pk-fk-jose_a_gomez_diaz` from the dropdown menu ([open cluster configuration](https://adb-3987092476296021.1.azuredatabricks.net/#setting/clusters/0902-110133-yuybgzda/configuration)). <br />
