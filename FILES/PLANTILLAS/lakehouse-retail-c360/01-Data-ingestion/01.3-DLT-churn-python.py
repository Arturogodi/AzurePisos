...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3987092476296021&notebook=%2F01-Data-ingestion%2F01.3-DLT-churn-python&demo_name=lakehouse-retail-c360&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F01-Data-ingestion%2F01.3-DLT-churn-python&version=1">
...
# MAGIC %md
# MAGIC Your DLT Pipeline has been installed and started for you! Open the <a dbdemos-pipeline-id="dlt-churn" href="#joblist/pipelines/e60126b0-72ea-417e-af6d-e54dbde158b0" target="_blank">Churn Delta Live Table pipeline</a> to see it in action.<br/>
...
# MAGIC
# MAGIC Open the <a dbdemos-pipeline-id="dlt-churn" href="#joblist/pipelines/e60126b0-72ea-417e-af6d-e54dbde158b0" target="_blank">Churn Delta Live Table pipeline</a> and click on start to visualize your lineage and consume the new data incrementally!
...
# MAGIC
# MAGIC <a dbdemos-dashboard-id="dlt-quality-stat" href='/sql/dashboardsv3/01ef69195b13173083d17865d90a6a95' target="_blank">Data Quality Dashboard</a>
...
# MAGIC
# MAGIC <a dbdemos-dashboard-id="churn-universal" href='/sql/dashboardsv3/01ef69195b13173083d17865d90a6a95'  target="_blank">Open the DBSQL Dashboard</a>
