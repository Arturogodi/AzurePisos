...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3987092476296021&notebook=%2F05-Workflow-orchestration%2F05-Workflow-orchestration-churn&demo_name=lakehouse-retail-c360&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F05-Workflow-orchestration%2F05-Workflow-orchestration-churn&version=1">
...
# MAGIC %md
# MAGIC A workflow was created as part of this demo. Open the <a dbdemos-workflow-id="init-job" href="#job/605981997554616/tasks" target="_blank">C360 Churn Workflow</a> to start exploring Databricks orchestration capabilities!
