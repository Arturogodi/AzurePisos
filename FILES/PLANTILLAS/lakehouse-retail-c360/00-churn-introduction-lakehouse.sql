...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3987092476296021&notebook=%2F00-churn-introduction-lakehouse&demo_name=lakehouse-retail-c360&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F00-churn-introduction-lakehouse&version=1">
...
-- MAGIC %md 
-- MAGIC Open the [Data Warehousing notebook]($./03-BI-data-warehousing/03-BI-Datawarehousing) to start running your BI queries or access or directly open the <a dbdemos-dashboard-id="churn-universal" href='/sql/dashboardsv3/01ef69195a301a84923ea24ed8cb5bc1' target="_blank">Churn Analysis Dashboard</a>
...
-- MAGIC %md
-- MAGIC
-- MAGIC Open the <a dbdemos-dashboard-id="churn-prediction" href='/sql/dashboardsv3/01ef69195a301a84923ea24ed8cb5bc1' target="_blank">Churn prediction DBSQL dashboard</a> to have a complete view of your business, including churn prediction and proactive analysis.
